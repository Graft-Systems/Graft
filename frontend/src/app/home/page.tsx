...
export default function HomePage() {
  return (
    <>
      <Navbar /> 
      <main className="flex min-h-screen flex-col bg-white text-gray-800 pt-20">
        {/* HERO — PARALLAX */}
        ...
        <ParallaxSection
          title="The Problem"
          text="Retailers face guesswork. Producers lack visibility. Traditional distributors hide where bottles land, can't predict reorders, and treat data as an afterthought."
        ...
        <ParallaxSection
          title="For Retailers"
          text="Approve a pre-filled weekly order in minutes. Cut stockouts, free cash from slow movers, and price confidently using neighborhood-specific insights."
        ...
        <ParallaxSection
          ...
          text="We combine POS data, delivery data, demographics, promotions, and price history to forecast demand, optimize inventory, and reveal the next best store to open."
...
// ... (Rest of ParallaxSection and TextSection components remain the same)
