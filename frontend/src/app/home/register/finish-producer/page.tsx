...
const StepIndicator = ({ currentStep, totalSteps = 3 }: { currentStep: Step, totalSteps?: number }) => {
    const stepLabels = ['Basic Info', 'Location', 'Contact'];
...
export default function FinishProducerPage() {
    ...
    const validateStep = (step: Step) => {
        ...
        if (step === 2 && !formData.region.trim()) {
        ...
        <div className="h-screen flex flex-col overflow-hidden">
            ...
            <div className="flex-1 overflow-y-auto bg-gray-50 text-gray-900 pt-36 pb-12 px-4 sm:px-6 lg:px-8">
                <div className="w-full max-w-3xl mx-auto">
                    ...
                    <h1 className="text-3xl font-bold text-rose-600 text-center mb-10">Complete Your Producer Profile</h1>
                        ...
                        {currentStep === 1 && (
                            <div className="space-y-8">
                                <div className="flex items-center space-x-3 pb-4 border-b border-gray-300 mb-6">
                                    <UserIcon className="h-7 w-7 text-rose-600" />
                                    <h2 className="text-xl font-semibold text-rose-600">1. Basic Information</h2>
                                </div>
                                <div className="space-y-4">
                                    <label htmlFor="name" className="block text-sm font-medium text-gray-700">
                                        Producer Name <span className="text-red-600">*</span>
                                    </label>
                                    <input
                                        type="text"
                                        name="name"
                            ...
                            <div className="space-y-8">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <input
                                        ...
                                        onChange={handleInputChange}
                                        className="block w-full sm:text-sm rounded-md border-gray-300 shadow-sm focus:ring-rose-600 focus:border-rose-600 py-2 px-3"
                                        placeholder="Enter your region (e.g., Napa Valley)"
                                    />
                                </div>
