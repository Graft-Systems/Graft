...
export default function AboutPage() {
    return (
        <>
            <Navbar /> {/* Added Navbar */}
            <div className="min-h-screen w-full bg-neutral-50 text-neutral-900 pt-32 p-10 flex flex-col gap-24">
                    ...
                    <div className="flex flex-col gap-16">
                        ...
                        {[
                            ...
                            },
                            {
                                ...
                                desc: "Jordan is a Junior at the University of Michigan from Macomb, Michigan, majoring in Computer Science."
                            }
                        ].map((p, idx) => (
                            <motion.div
                                key={idx}
